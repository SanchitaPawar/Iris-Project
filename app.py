...
st.set_page_config(page_title='Iris Project Sanchita', layout='wide')


# Show the title of app in the body
st.title('Iris Project - Sanchita Pawar')
...
if button:
    ...
    # Get the predictions along with probabality 
